    ...
    public class RepScheduleRespository
    {
        ...
        public async Task<List<TreatingAlimentMapMedicine>> GetMedicineTreatingAlimentMap()
        {
            ...
            using (var httpClient = new HttpClient(handler))//handler
            {
                ...
                using (var response = await httpClient.GetAsync("http://40.71.234.220/api/MedicineStockInformation")) //Call the httpget of MedicineStokeInformation api to fetch  all Medicine stoke info.
                {
